...
void test_abastar() { ///(a + ba)*
    ...
    NKA g1 = g.delete_E().delete_unreachable_verticles();
    ...
    NKA g2 = g1.build_DKA().delete_unreachable_verticles();
    NKA true_g2(4, 0, {0, 3});
    ...
    NKA g3 = g2.get_PDKA().delete_unreachable_verticles();
    NKA true_g3(5, 0, {0, 3});
    ...
    mDKA_to_regular r(g4);
    assert(r.get_regular() == "(a+ba)*");
}
